...
const SIMILAR_TYPES: Record<SlideType, SlideType[]> = {
  ...
  CONCLUSION: [],
  APPENDIX: [],
  // 第一阶段新增：结构化图形类型（彼此可互为替代，避免连续重复）
  PYRAMID_HIERARCHY: ["DECISION_PATH", "PRODUCT_HOUSE", "KEY_FINDING"],
  DECISION_PATH: ["PYRAMID_HIERARCHY", "PRODUCT_HOUSE", "JOURNEY", "PROCESS"],
  PRODUCT_HOUSE: ["PYRAMID_HIERARCHY", "DECISION_PATH", "THREE_INSIGHTS"],
};
